...
tool_type: cli
primary_tool: fastqc
source: https://github.com/GPTomics/bioSkills/tree/main/read-qc/quality-reports
note_for_this_project: PRJEB40348 is an AMPLICON library (VH/VL Ig fragments) — per the "false-fail" insight below, expect FastQC to flag duplication and GC content as warn/fail even though that is expected for targeted amplicon data, not a defect.
---
